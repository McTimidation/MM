...
function PortfolioPage() {
    ...
    return (
        <div className='row'>
            ...
            <ProjectCard title={'Randon Story Generator'} liveDemo={'https://github.com/McTimidation/random-story-generator'} repoLink={'#'} imgsrc={randoStory} text={'A fun random story generator'} />
